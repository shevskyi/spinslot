...
export const slotSpins = [
    // Spin 1: win1
    [
        ["lv1", "lv2", "hv1", "lv3", "lv1", "lv2"],
        ["lv2", "lv1", "lv3", "hv2", "lv2", "wild"],
        ["hv3", "lv4", "scatter", "lv5", "lv4", "lv3"],
        ["lv1", "hv4", "hv2", "lv3", "lv5", "lv2"],
        ["lv2", "lv3", "hv1", "lv1", "scatter", "lv4"]
    ],
    // Spin 2: win2
    [
        ["hv2", "wild", "lv2", "hv2", "lv3", "lv2"],
        ["wild", "hv2", "lv2", "lv2", "wild", "lv3"],
        ["hv2", "scatter", "hv3", "hv4", "wild", "hv3"],
        ["scatter", "wild", "lv3", "hv2", "lv2", "hv4"],
        ["lv1", "lv3", "hv2", "wild", "hv3", "hv2"]
    ],
    // Spin 3: fake
    [
        ["lv2", "lv3", "lv4", "lv5", "lv1", "lv3"],
        ["lv1", "lv5", "lv2", "lv4", "lv3", "lv2"],
        ["lv3", "lv4", "lv1", "lv2", "lv3", "lv4"],
        ["lv2", "lv3", "lv2", "lv4", "lv1", "lv3"],
        ["lv5", "lv4", "lv3", "lv1", "lv2", "lv1"]
    ],
    // Spin 4: mega
    [
        ["hv1", "hv2", "wild", "scatter", "hv3", "hv4"],
        ["hv2", "wild", "scatter", "hv2", "wild", "scatter"],
        ["wild", "scatter", "hv2", "wild", "scatter", "hv4"],
        ["scatter", "hv3", "hv4", "wild", "hv2", "wild"],
        ["hv3", "hv4", "wild", "scatter", "hv2", "wild"]
    ]
];

// Індекси виграшних символів в grid для кожної фази
export const winIndexes = {
    win1: [2, 3, 4, 17, 19], // для прикладу
    win2: [7, 8, 9, 10, 11, 12],
